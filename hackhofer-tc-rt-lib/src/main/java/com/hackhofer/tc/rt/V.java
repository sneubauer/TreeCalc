...
import static com.hackhofer.tc.rt.B.convertToDate;
import static com.hackhofer.tc.rt.B.formatDate;
...
public abstract class V  {
	...
	public V divint(final V r) {  
		double left = doubleValue();
		double right = r.doubleValue(); /* bug in vpms: just integer value of divisor is used */
